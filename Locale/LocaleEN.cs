...
namespace BrushSizeUnlimiter.Locale
{
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            ...
            string brushPreviewModDescription = "Having this enabled massively improves performance when using large object brushes (\u22652500 size) by temporarily setting the brush strength in the background while hovering to 0." + new string('\r', 105) + "Warning: Disabling this will make large object brushes with high strengths extremely laggy." + new string('\r', 160) + "Disable if there is compatibility issues";
